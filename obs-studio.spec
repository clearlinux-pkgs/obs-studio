...
Version  : 28.1.2
Release  : 40
URL      : https://github.com/obsproject/obs-studio/archive/28.1.2/obs-studio-28.1.2.tar.gz
Source0  : https://github.com/obsproject/obs-studio/archive/28.1.2/obs-studio-28.1.2.tar.gz
...
%prep
%setup -q -n obs-studio-28.1.2
cd %{_builddir}/obs-studio-28.1.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672930998
mkdir -p clr-build
pushd clr-build
